...
// echo $anfang_1." ".$end_1." ".$anfang_2." ".$emd_2." ".$anfang_3." ".$emd_3;
// var_dump(("bool") );
...
// $interval1 =$diff->format("Total number of days: %a.");
// $interval =(int)$diff->format("%a");

// echo $interval .'<br>';
// echo  var_dump($interval);

// convert to Date .. Date to +1 to handel
// $startDate = date ('Y-m-d',strtotime($anfang_1));
...
// da sind alle variable
// echo "<pre>";
// print_r($_SERVER);
// echo "</pre>";

// if($_SERVER["REQUEST_METHOD"] == "POST") {
//     $requestForm = array(       $_POST['published_from_1'],
...
// echo pahtinfo(__FILE__, PATHINFO_DIRNAME). "<br>";

// query für ersten Filter 
use App\Request;
